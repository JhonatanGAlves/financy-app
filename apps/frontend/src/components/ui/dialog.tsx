      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="absolute top-3 right-3 flex items-center justify-center size-8 rounded-lg border border-gray-300 text-gray-500 hover:bg-gray-50 cursor-pointer transition-colors"
          >
